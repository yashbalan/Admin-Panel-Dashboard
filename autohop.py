    ...
    if past_bookings_df.empty or drivers_shifts_df.empty:
        ...
        with tab3:
            ...
            if analysis_type == 'Weekly':
                ...
                weekly_filtered_data = weekly_filtered_data[(weekly_filtered_data['EPOD Name'].isin(weekly_epod)) & (
        ...
        with tab4:
            ...
            average_kwh = filtered_df.groupby('subscriptionName')['KWH Pumped Per Session'].mean().reset_index().round(
                1)
        ...
        with tab7:
            ...
            def process_files(files):
                ...
                weekly_kms = vehicle_df_melted.groupby(['Name', 'Week'])[
                    'KM Travelled for Session'].mean().reset_index()

                # Monthly analysis
                vehicle_df_melted['Month'] = vehicle_df_melted['Actual Date'].dt.month
                monthly_kms = vehicle_df_melted.groupby(['Name', 'Month'])[
                    'KM Travelled for Session'].mean().reset_index()
